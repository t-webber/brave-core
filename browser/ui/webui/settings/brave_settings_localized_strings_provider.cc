...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"enablePsstDialogLabelDesc",
       IDS_SETTINGS_BRAVE_SHIELDS_PSST_ASK_AGAIN_LABEL},
      {"enablePsstDialogSubLabelDesc",
       IDS_SETTINGS_BRAVE_SHIELDS_PSST_ASK_AGAIN_SUB_LABEL},
