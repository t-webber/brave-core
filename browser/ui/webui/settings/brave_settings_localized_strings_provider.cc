...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      {"emailAliasesShortDescription", IDS_SETTINGS_EMAIL_ALIASES_SHORT_DESCRIPTION},
      ...
      {"emailAliasesConnectingToBraveAccount", IDS_SETTINGS_EMAIL_ALIASES_CONNECTING_TO_BRAVE_ACCOUNT},
      {"emailAliasesBraveAccount", IDS_SETTINGS_EMAIL_ALIASES_BRAVE_ACCOUNT},
      {"emailAliasesCopiedToClipboard", IDS_SETTINGS_EMAIL_ALIASES_COPIED_TO_CLIPBOARD},
      {"emailAliasesClickToCopyAlias", IDS_SETTINGS_EMAIL_ALIASES_CLICK_TO_COPY_ALIAS},
      ...
      {"emailAliasesCreateDescription", IDS_SETTINGS_EMAIL_ALIASES_CREATE_DESCRIPTION},
      {"emailAliasesListTitle", IDS_SETTINGS_EMAIL_ALIASES_LIST_TITLE},
      {"emailAliasesCreateAliasTitle", IDS_SETTINGS_EMAIL_ALIASES_CREATE_ALIAS_TITLE},
      {"emailAliasesCreateAliasLabel", IDS_SETTINGS_EMAIL_ALIASES_CREATE_ALIAS_LABEL},
      {"emailAliasesRefreshButtonTitle", IDS_SETTINGS_EMAIL_ALIASES_REFRESH_BUTTON_TITLE},
      {"emailAliasesNoteLabel", IDS_SETTINGS_EMAIL_ALIASES_NOTE_LABEL},
      {"emailAliasesEditNotePlaceholder", IDS_SETTINGS_EMAIL_ALIASES_EDIT_NOTE_PLACEHOLDER},
      ...
      {"emailAliasesEmailsWillBeForwardedTo", IDS_SETTINGS_EMAIL_ALIASES_EMAILS_WILL_BE_FORWARDED_TO},
      {"emailAliasesEditAliasTitle", IDS_SETTINGS_EMAIL_ALIASES_EDIT_ALIAS_TITLE},
      {"emailAliasesCreateAliasButton", IDS_SETTINGS_EMAIL_ALIASES_CREATE_ALIAS_BUTTON},
      {"emailAliasesSaveAliasButton", IDS_SETTINGS_EMAIL_ALIASES_SAVE_ALIAS_BUTTON},
      {"emailAliasesSignInOrCreateAccount", IDS_SETTINGS_EMAIL_ALIASES_SIGN_IN_OR_CREATE_ACCOUNT},
      {"emailAliasesEnterEmailToGetLoginLink", IDS_SETTINGS_EMAIL_ALIASES_ENTER_EMAIL_TO_GET_LOGIN_LINK},
      {"emailAliasesGetLoginLinkButton", IDS_SETTINGS_EMAIL_ALIASES_GET_LOGIN_LINK_BUTTON},
      {"emailAliasesEmailAddressPlaceholder", IDS_SETTINGS_EMAIL_ALIASES_EMAIL_ADDRESS_PLACEHOLDER},
      {"emailAliasesLoginEmailOnTheWay", IDS_SETTINGS_EMAIL_ALIASES_LOGIN_EMAIL_ON_THE_WAY},
      {"emailAliasesClickOnSecureLogin", IDS_SETTINGS_EMAIL_ALIASES_CLICK_ON_SECURE_LOGIN},
