...
function storeFeedSpecifier(specifier: NewsFeedSpecifier) {
  ...
  localStorage.setItem(specifierStorageKey, json)
  sessionStorage.setItem(specifierStorageKey, json)
}

function loadFeedSpecifier(): NewsFeedSpecifier | null {
  const storageValue =
    localStorage.getItem(specifierStorageKey) ||
    sessionStorage.getItem(specifierStorageKey)
