...
public class NTPImageUtil {
    ...
    // TODO(alexeybarabash): the method seems unused, but let's ask author
    // These:
    //      R.string.you_are_earning_tokens
    //      R.string.earn_tokens_for_viewing
    // then also will become unused.
