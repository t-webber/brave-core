...
public class BraveNewTabPageLayout
    ...
    private void showNTPImage(NTPImage ntpImage) {
        ...
        boolean backgroundImageShown = true;
        if (ntpImage instanceof Wallpaper && ((Wallpaper) ntpImage).isRichMedia()) {
            ...
            backgroundImageShown = false;
        }

        if (backgroundImageShown && ntpImage instanceof Wallpaper) {
            BraveNewTabTakeoverInfobar.show(mProfile);
        }
    }
